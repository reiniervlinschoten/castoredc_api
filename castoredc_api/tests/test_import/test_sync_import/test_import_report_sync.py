...
class TestImportReportSync:
    ...
    report_error_wrong_field = "{'pat_sex': ['BAD_REQUEST', 'Unsupported field type']} caused at {'record_id': '110001', 'med_name': 'Azathioprine', 'med_start': '05-12-2019', 'med_stop': '05-12-2020', 'med_dose': '0.05', 'med_units': '3', 'med_other_unit': None, 'pat_sex': '0', 'success': {'med_name': 'Azathioprine', 'med_start': '05-12-2019', 'med_stop': '05-12-2020', 'med_dose': '0.05', 'med_units': '3'}, 'failed': {'pat_sex': ['BAD_REQUEST', 'Unsupported field type']}}.\n See output folder for successful imports"
