...
class TestDataInterpretationFormatting:
    """Tests the transformation of string values to the proper data format for analysis."""

    @pytest.fixture(scope="class")
    def integration_study_format_optiongroups(self, integration_study_format):
        integration_study_format.map_data()
        return integration_study_format

    def test_data_interpret_number(self, integration_study_format_optiongroups):
        # Get data point with type radio
        dp = integration_study_format_optiongroups.get_single_data_point(
            "110014", "1046822E-8C8B-4D8B-B29C-183CAC8B28AF", "his_smoke_dose"
        )
        # Test if answer is correct
        assert dp.value == 5

    def test_data_interpret_radio(self, integration_study_format_optiongroups):
        # Get data point with type radio
        dp = integration_study_format_optiongroups.get_single_data_point(
    ...
    def test_data_interpret_dropdown(self, integration_study_format_optiongroups):
    ...
    def test_data_interpret_checkbox_single(
    ...
    def test_data_interpret_checkbox_multiple(
        self, integration_study_format_optiongroups
    ):
    ...
    def test_data_interpret_date(self, integration_study_format_optiongroups):
        # Get data point with type date
        dp = integration_study_format_optiongroups.get_single_data_point(
            "110014", "1046822E-8C8B-4D8B-B29C-183CAC8B28AF", "ic_date"
        )
        # Test if answer is correct
        assert dp.value == "May 12 2020"

    def test_data_interpret_year(self, integration_study_format_optiongroups):
    ...
    def test_data_interpret_date_time(self, integration_study_format_optiongroups):
        # Get data point with type date time
        dp = integration_study_format_optiongroups.get_single_data_point(
            "110014", "A6CDB606-D094-4969-A984-7CA6E8B45883", "onset_stroke"
        )
        # Test if answer is correct
        assert dp.value == "May 11 2020 07:30 AM"

    def test_data_interpret_time(self, integration_study_format_optiongroups):
        # Get data point with type time
        dp = integration_study_format_optiongroups.get_single_data_point(
            "110014", "A6CDB606-D094-4969-A984-7CA6E8B45883", "onset_trombectomy"
        )
        # Test if answer is correct
        assert dp.value == "09:25 AM"

    def test_data_interpret_calc(self, integration_study_format_optiongroups):
    ...
    def test_data_interpret_slider(self, integration_study_format_optiongroups):
    ...
    def test_data_interpret_text(self, integration_study_format_optiongroups):
    ...
    def test_data_interpret_text_multi(self, integration_study_format_optiongroups):
    ...
    def test_data_interpret_randomization(self, integration_study_format_optiongroups):
    ...
    def test_data_interpret_file(self, integration_study_format_optiongroups):
    ...
    def test_data_interpret_number_and_date(
        ...
        assert "January 14 2021" in dp.value

    def test_data_interpret_missing(self, integration_study_format_optiongroups):
