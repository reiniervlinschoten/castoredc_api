...
class TestDataInterpretation:
    ...
    def test_data_interpret_number(self, integration_study_mapped):
        # Get data point with type radio
        dp = integration_study_mapped.get_single_data_point(
            "110014", "1046822E-8C8B-4D8B-B29C-183CAC8B28AF", "his_smoke_dose"
        )
        # Test if answer is correct
        assert dp.value == 5

    def test_data_interpret_radio(self, integration_study_mapped):
        # Get data point with type radio
        dp = integration_study_mapped.get_single_data_point(
    ...
    def test_data_interpret_dropdown(self, integration_study_mapped):
    ...
    def test_data_interpret_checkbox_single(self, integration_study_mapped):
    ...
    def test_data_interpret_checkbox_multiple(self, integration_study_mapped):
    ...
    def test_data_interpret_date(self, integration_study_mapped):
    ...
    def test_data_interpret_year(self, integration_study_mapped):
    ...
    def test_data_interpret_date_time(self, integration_study_mapped):
    ...
    def test_data_interpret__time(self, integration_study_mapped):
    ...
    def test_data_interpret_calc(self, integration_study_mapped):
    ...
    def test_data_interpret_slider(self, integration_study_mapped):
    ...
    def test_data_interpret_text(self, integration_study_mapped):
    ...
    def test_data_interpret_text_multi(self, integration_study_mapped):
    ...
    def test_data_interpret_randomization(self, integration_study_mapped):
    ...
    def test_data_interpret_file(self, integration_study_mapped):
    ...
    def test_data_interpret_number_and_date(self, integration_study_mapped):
    ...
    def test_data_interpret_missing(self, integration_study_mapped):
