...
import castoredc_api_study.castor_objects.castor_record as castor_record
...
import castoredc_api_study.castor_objects.castor_form_instance as castor_form_instance
from castoredc_api_study.castor_objects import castor_data_point
...
def study() -> castor_study.CastorStudy:
    ...
    # Fake for tests
    study.form_links = {
        "Survey": {"FAKE-SURVEY-ID1": ["Fake Survey"]},
        "Report": {
            "FAKE-REPORT-ID1": ["FAKE-REPORT-INSTANCE-ID1",],
            "FAKE-REPORT-ID2": ["FAKE-REPORT-INSTANCE-ID2",],
        },
    }
    return study
